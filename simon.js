$(document).ready(function(){
  ...
  citySound = document.getElementById("citynoise");
  citySound.play();
  ...
  if(!AudioContext) {
    ...
    function addStep(){
      ...
      var divArray = $('.push');
      var divsToMove = shuffle(divArray);
      moveDivs(divsToMove);

    };

    function moveDivs(divsToMove){
      var positions = ['t-l', 'b-l', 't-r', 'b-r'];
      for(var i =0; i<divsToMove.length; i++){
        console.log(divsToMove[i]);
        divsToMove[i].classList.remove('b-l');
        divsToMove[i].classList.remove('t-l');
        divsToMove[i].classList.remove('b-r');
        divsToMove[i].classList.remove('t-r');
        divsToMove[i].classList.add(positions[i]);
      }
    }
...
$('#3').mousedown(function() {
  $('#3').animate({width: "450px", height: "450px"},500).animate({width: "400px",height: "400px"},500);
});
$('#0').mousedown(function() {
  $('#0').animate({width: "450px", height: "450px"},500).animate({width: "400px",height: "400px"},500);
});
$('#1').mousedown(function() {
  $('#1').animate({width: "450px", height: "450px"},500).animate({width: "400px",height: "400px"},500);
});
$('#2').mousedown(function() {
  $('#2').animate({width: "450px", height: "450px"},500).animate({width: "400px",height: "400px"},500);
});
